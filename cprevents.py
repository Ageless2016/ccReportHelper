...
class EventRecord():
    ...
    def __eq__(self, other):
        return self.city+self.testpoint_name+self.testscene+self.servicetype+self.abnormaltype == \
               other.city+other.testpoint_name+other.testscene+other.servicetype+other.abnormaltype

    def __hash__(self):
        return hash(self.city+self.testpoint_name+self.testscene+self.servicetype+self.abnormaltype)

    def __repr__(self):
        outstr = "city:{}\ntestpoint_name:{}\ntestscene:{}\nservicetype:{}\ntotalcount:{}\ncoveredcount:{}\nabnormaltype:{}\nabnormaldetaillist:{}\n".format(
            self.city,self.testpoint_name,self.testscene,self.servicetype,self.totalcount,self.coveredcount,self.abnormaltype,self.abnormaldetaillist)
        return outstr
